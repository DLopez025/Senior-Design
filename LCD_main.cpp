...
// const byte addresses[][6] = {"00001", "00002", "00003"}; // to motor, from joystick, from motor
byte pipenum;
...
void setup() {
  ...
  radio.openWritingPipe(LCDpipe);    //00001 = To motor
  radio.openReadingPipe(0, JoyPipe); //00002 = from joystick
  radio.openReadingPipe(1, Motorpipe); //00003 = from Motor
...
void loop() {
  ...
  // Serial.println(Y);
  // if(Y==1){
  //   temp[0] = 10; temp[1] = 897;
  //   radio.stopListening();
  //   radio.write(&temp, sizeof(temp));
  // }
  // if(Y==2){
  //   temp[0] = 17; temp[1] = 327;
  //   radio.stopListening();
  //   radio.write(&temp, sizeof(temp));
  // }
